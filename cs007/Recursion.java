...
public class Recursion
{
	...
	{	
		if (n==0) return 0;
		if (n%10==8 && n%10==(n/10)%10) return 2 + count8s(n/10);
		if (n%10==8) return 1 + count8s(n/10);
		return count8s(n/10);
	}
	...
	{	
		...
		return isSorted(array, i+1, count);			                  //No [] after array
	}
	...
	{	
		...
		if (s.indexOf(lo)!=s.indexOf(hi)) return false;
